...
export default function Home() {
  ...
  return (
    <main className="mx-auto w-full max-w-md p-4 space-y-6">
      {/* Profile header */}
      <section className="glass-card p-6 card-shine glow">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold leading-tight gradient-text">{user.name}</h1>
      ...
      <section className="grid grid-cols-2 gap-4">
        <div className="group glass-card p-5 card-3d hover:shadow-2xl hover:scale-[1.03] transition-all duration-300 cursor-pointer">
      ...
      <section className="space-y-4">
        ...
        <div className="glass-card overflow-hidden card-shine">
            ...
            {user.investments.map((inv, idx) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-xl ${idx === 0 ? 'bg-gradient-to-br from-blue-500 to-blue-600' : 'bg-gradient-to-br from-purple-500 to-purple-600'} flex items-center justify-center text-white font-bold text-sm shadow-lg shimmer`}>
                    {inv.type.slice(0, 2)}
                  </div>
      ...
      <section className="pt-4">
        <Button asChild className="w-full h-14 rounded-2xl shadow-xl hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 bg-gradient-to-r from-primary via-blue-600 to-primary hover:from-blue-600 hover:to-primary text-lg font-bold btn-premium">
